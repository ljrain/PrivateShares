...
$dataFilePath = "$crmtoolkitPath\Binaries\XMLFiles\DBPop\Field" + $NumOfUsers
...
PopulateData $dbPopExe "$dataFilePath\1BookingStatusRecords.xml"
PopulateData $dbPopExe "$dataFilePath\1ProductsAndRelatedRecords.xml"
PopulateData $dbPopExe "$dataFilePath\2BaseEntityPop.xml"
PopulateData $dbPopExe "$dataFilePath\3AccountsAndRelatedRecords.xml"
PopulateData $dbPopExe "$dataFilePath\4ResourcesPop.xml"
PopulateData $dbPopExe "$dataFilePath\6IncidentTypesPop.xml"
PopulateData $dbPopExe "$dataFilePath\8WorkOrdersWithoutIncidents.xml"
