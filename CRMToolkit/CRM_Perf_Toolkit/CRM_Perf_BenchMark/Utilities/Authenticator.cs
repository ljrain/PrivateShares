...
namespace CRM_Perf_BenchMark
{
    ...
    {
        public static List<KeyValuePair<string, string>> authPairs { get; set; }
        public Guid clientId { get; set; }

        public KeyValuePair<string, string> user { get; set; }

        public async Task<AuthenticationResult> GetToken(string tenantid, string username, System.Security.SecureString password, List<string> scopes  )
        {
            //TenantId needs to be updated for customer
            //string tenantid = "338ba25e-35ed-4ba6-a1c3-984477ca9faa";
            string clientid = "3e62f81e-590b-425b-9531-cad6683656cf";

            //List<string> scopes = new List<string>();
            //scopes.Add("https://service.powerapps.com//.default");
            ...
            if (result == null)
            {
                result = await GetTokenForWebApiUsingUsernamePasswordAsync(scopes, username, password,app);
            }

            return result;
        }

        public async Task<AuthenticationResult> GetTokenForWebApiUsingUsernamePasswordAsync(IEnumerable<string> scopes, string username, SecureString password, IPublicClientApplication App)
        {
            AuthenticationResult result = null;
            try
            {
